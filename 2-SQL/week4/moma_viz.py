...
def task2():
    ...
    # TODO task 2
    query = "SELECT classification, COUNT(classification) FROM moma_works GROUP BY classification HAVING COUNT(classification) > 100 ORDER BY count DESC;"
...
def task3():
    ...
    # TODO task 3
    query = "SELECT nationality, COUNT(nationality) FROM (SELECT info->>'nationality' as nationality FROM moma_artists) AS nations GROUP BY nationality ORDER BY count DESC LIMIT 10;"
...
def task4():
    ...
    # TODO task 4
    query = "SELECT gender, COUNT(gender) FROM (SELECT UPPER(info->>'gender') as gender FROM moma_artists) AS genders WHERE gender IS NOT NULL GROUP BY gender ORDER BY count DESC;"
